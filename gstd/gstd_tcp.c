...
GstdReturnCode
gstd_tcp_add_listerner_address (GstdSocket * base, GSocketService ** service);
...
gstd_tcp_class_init (GstdTcpClass * klass)
{
  ...
  socket_class->add_listerner_address =
      GST_DEBUG_FUNCPTR (gstd_tcp_add_listerner_address);
