...
gstd_msg_type_get_type (void)
{
  ...
  static const GFlagsValue gstd_msg_type[] = {
    ...
    {GST_MESSAGE_STRUCTURE_CHANGE, "GST_MESSAGE_STRUCTURE_CHANGE", "structure_change"},
    ...
    {GST_MESSAGE_DURATION_CHANGED, "GST_MESSAGE_DURATION_CHANGED", "duration_changed"},
    {GST_MESSAGE_DURATION_CHANGED, "GST_MESSAGE_DURATION_CHANGED", "duration-changed"},
    ...
    {GST_MESSAGE_DEVICE_REMOVED, "GST_MESSAGE_DEVICE_REMOVED", "device_removed"},
    {GST_MESSAGE_DEVICE_REMOVED, "GST_MESSAGE_DEVICE_REMOVED", "device-removed"},
#endif
#if GST_VERSION_MINOR >= 10
    {GST_MESSAGE_PROPERTY_NOTIFY, "GST_MESSAGE_PROPERTY_NOTIFY", "property_notify"},
    {GST_MESSAGE_PROPERTY_NOTIFY, "GST_MESSAGE_PROPERTY_NOTIFY", "property-notify"},
    {GST_MESSAGE_STREAM_COLLECTION, "GST_MESSAGE_STREAM_COLLECTION", "stream_collection"},
    {GST_MESSAGE_STREAM_COLLECTION, "GST_MESSAGE_STREAM_COLLECTION", "stream-collection"},
    {GST_MESSAGE_STREAMS_SELECTED, "GST_MESSAGE_STREAMS_SELECTED", "streams_selected"},
    {GST_MESSAGE_STREAMS_SELECTED, "GST_MESSAGE_STREAMS_SELECTED", "streams-selected"},
